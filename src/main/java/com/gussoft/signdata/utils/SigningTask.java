...
import com.gussoft.signdata.RemoteDocumentSignatureServiceBuilder;
import com.gussoft.signdata.RemoteTrustedListSignatureServiceBuilder;
import com.gussoft.signdata.exception.ApplicationException;
import com.gussoft.signdata.models.SignatureModel;
import com.gussoft.signdata.models.SignatureOption;
import javax.swing.*;
...
public class SigningTask {
    ...
    private static final Logger log = LoggerFactory.getLogger(SigningTask.class);
    ...
    public DSSDocument call() throws Exception {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(
                    null, e.getMessage(), model.getFileToSign().getAbsolutePath(), 0);
        }
    ...
    private DSSPrivateKeyEntry getSigner(List<DSSPrivateKeyEntry> keys) throws Exception {
        ...
        if (Utils.isCollectionEmpty(keys)) {
            ...
            SelectCertificateTask selectCertificate = new SelectCertificateTask(keys);
            selectedKey = selectCertificate.call();
            if (selectedKey == null) {
    ...
    private void throwException(String message, Exception e) {
        ...
        //updateProgress(0, 100);
        JOptionPane.showMessageDialog(null, exceptionMessage, "Generic Message System",0);
        log.error("Error : " + e);
